        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NearbyChairsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChairNearbyChairs", x => new { x.ChairId, x.NearbyChairsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ChairNearbyChairs_Chairs_NearbyChairsId",
                        column: x => x.NearbyChairsId,
                        principalTable: "Chairs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChairNearbyChairs_NearbyChairsId",
                table: "ChairNearbyChairs",
                column: "NearbyChairsId");
